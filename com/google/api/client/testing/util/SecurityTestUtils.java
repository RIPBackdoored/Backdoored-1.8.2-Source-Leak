...
public final class SecurityTestUtils
{
    ...
    public static RSAPrivateKey newRsaPrivateKey() throws GeneralSecurityException {
        final KeyFactory v1 = SecurityUtils.getRsaKeyFactory();
        final KeySpec v2 = new PKCS8EncodedKeySpec(SecurityTestUtils.ENCODED_PRIVATE_KEY);
        return (RSAPrivateKey)v1.generatePrivate(v2);
    }
    
    public static RSAPublicKey newRsaPublicKey() throws GeneralSecurityException {
        final KeyFactory v1 = SecurityUtils.getRsaKeyFactory();
        final KeySpec v2 = new X509EncodedKeySpec(SecurityTestUtils.ENCODED_PUBLIC_KEY);
        return (RSAPublicKey)v1.generatePublic(v2);
    }
